...
MuseScore {
    ...
    //4.4 title: "IEEE1599 Converter 4.4"
    //4.4 thumbnailName: "ieee1599musescore.png"
    //4.4 categoryCode: "File Conversion"
    Component.onCompleted: {
        if (mscoreMajorVersion >= 4 && mscoreMinorVersion <= 3) {
            title: "IEEE1599 Converter 4.0-4.3";
...
// File names -------------------------------------------------
    ...
    //     MouseArea {
    //         anchors.fill: parent
    //         onClicked: directorySelectDialog.visible=true
    //     }
    //             palette.buttonText:"black"
    ...
    Button {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: textFieldFilePath.text = ""
        }
                palette.buttonText:"black"
